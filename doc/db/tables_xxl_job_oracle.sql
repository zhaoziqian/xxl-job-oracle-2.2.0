...
(
    ID                        NUMBER(11)
        CONSTRAINT XXL_JOB_INFO_PK PRIMARY KEY,
...
(
    ID                        NUMBER(20)           NOT NULL
        CONSTRAINT XXL_JOB_LOG_PK PRIMARY KEY,
    JOB_GROUP                 NUMBER(11)           NOT NULL,
...
VALUES (1, 1, '0 0 0 * * ? *', '测试任务1', TO_DATE('2018-11-03 22:21:31', 'yyyy-mm-dd hh24:mi:ss'),
        TO_DATE('2018-11-03 22:21:31', 'yyyy-mm-dd hh24:mi:ss'), 'XXL', '', 'FIRST', 'demoJobHandler',
        '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', TO_DATE('2018-11-03 22:21:31', 'yyyy-mm-dd hh24:mi:ss'),
        '');
